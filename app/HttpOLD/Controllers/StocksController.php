...
//    }
    ...
    public function getStockList()
    {
       ...
       // $stock = DB::table("stocks")->pluck("product_id");
        ...
        $products = DB::table("products")->whereIn('id', $stock)->orderBy('name', 'asc')->pluck("name","id");
...
//        return redirect('/shop-management');
    ...
    public function search(Request $request) {
        ...
        $stocks = $this->doSearchingQuery($constraints);
        return view('stocks/index', ['stocks' => $stocks, 'searchingVals' => $constraints]);
    }
