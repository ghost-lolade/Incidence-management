            ...
            <div class="col-md-12 col-md-offset-0">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php echo Form::open(['method'=>'POST', 'action'=> 'ServiceLevelAggrementController@viewSLAReport', 'target'=>'_blank','files'=>true]); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" value="<?php echo e(old('from')); ?>" name="from_date" class="form-control pull-right" id="from" placeholder="Select Date" required>
                                    </div> </div>
                            </div>
                            <br/><br/>                         
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" value="<?php echo e(old('to')); ?>" name="to_date" class="form-control pull-right" id="to" placeholder="Select Date" required>
                                    </div> </div>
                            </div>
                            <br/><br/>                         
