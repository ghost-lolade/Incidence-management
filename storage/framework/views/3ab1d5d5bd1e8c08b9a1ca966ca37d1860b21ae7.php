    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <div class="row">
                    <div class="col-sm-8">
                        <h3 class="box-title">ATM Part :: <?php echo e($date = date('Y-m-d H:i:s')); ?></h3>
                    </div>
                    <div class="col-sm-4">
                                                <a class="btn btn-primary" href="<?php echo e(route('partreplace-management.create')); ?>">Add Cash & Charge</a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
                                ...
                                <?php $__currentLoopData = $atmparts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indexKey => $atmparts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="item<?php echo e($atmparts->id); ?>">
                                        ...
                                        <td>
                                            ...
                                            <form class="row" method="POST" action="<?php echo e(route('partreplace-management.destroy', ['id' => $atmparts->id])); ?>" onsubmit = "return confirm('Are you sure?')">
                                                <input type="hidden" name="_method" value="DELETE">
                                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                <a href="<?php echo e(route('partreplace-management.edit', ['id' => $atmparts->id])); ?>" class="btn btn-warning col-sm-3 col-xs-2 btn-margin">
                                                    Update
                                                </a>
