            ...
            <div class="box-header">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <h3 class="box-title">List of Customer Engineer <?php echo e($date = date('Y-m-d H:i:s')); ?> </h3>
                    </div>
                    <div class="col-sm-4">
                        <a class="btn btn-primary" href="<?php echo e(route('requester-management.create')); ?>">Add Requester</a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
			          ...
			          <thead>
                                ...
                                <?php $__currentLoopData = $cedatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cedata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('requester-management.show', $cedata)); ?>" class="btn btn-success col-sm-3 col-xs-5 btn-margin">View</a>
