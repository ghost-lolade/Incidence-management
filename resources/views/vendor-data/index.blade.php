            ...
            <div class="box-header">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <h3 class="box-title">List of Vendors (Data) {{$date = date('Y-m-d H:i:s')}} </h3>
                    </div>
                    <div class="col-sm-4">
                        <a class="btn btn-primary" href="{{ route('vendordata-management.create') }}">Add Vendor Data</a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
...
{{--                                        <td>{{$cedata->insurance ? $cedata->insurance->name : 'No atmreport type'}}</td>--}}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('vendordata-management.show', $cedata)}}" class="btn btn-success col-sm-3 col-xs-5 btn-margin">View</a>
