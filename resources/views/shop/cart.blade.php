...
@section('content')
    ...
    <div class="container">
        <p><a href="{{ url('shop/shop') }}">Home</a> / Cart</p>
        <h1>Your Cart</h1>
        ...
        @if (sizeof(Cart::content()) > 0)
            ...
            <table class="table">
                ...
                @foreach (Cart::content() as $item)
                    <tr>
                        ...
                        <td><a href="{{ url('shop/shop', [$item->model->id]) }}">{{ $item->name }}</a></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>&#x20A6 {{ Cart::instance('default')->subtotal() }}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="table-bg">&#x20A6 {{ Cart::total() }}</td>
            ...
            <div style="float:right">
                ...
                <a href="{{ url('/shop/proceed') }}" class="btn btn-success btn-lg">Proceed to Checkout</a>
