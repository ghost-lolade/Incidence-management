...
<body>
            ...
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <ul class="nav navbar-nav navbar-right">
                {{--<li class="{{ set_active('wishlist') }}">--}}
                    <a href="{{ url('/wishlist') }}">Wishlist ({{ Cart::instance('wishlist')->count(false) }})</a></li>
                {{--<li class="{{ set_active('cart') }}">--}}
                    <a href="{{ url('/cart') }}">Cart ({{ Cart::instance('default')->count(false) }})</a></li>
              </ul>
            </div><!--/.nav-collapse -->
          </div>
        </nav>
    ...
    <footer>
      <div class="container">
        <p class="text-muted">By <a href="http://uhl.com">Stephen Oladeji</a></p>
      </div>
    </footer>
