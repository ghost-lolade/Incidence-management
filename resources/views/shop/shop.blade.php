                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <ul class="nav navbar-nav navbar-center">
                                ...
                                <a class="btn btn-primary"    href="{{ url('/sale-management/create') }}"> Cart ({{ $count }})</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="price" type="text" class="form-control" name="unit_price" style="width:350px" >

                            {{--<select name="unit_price" id="price" class="form-control" style="width:350px"></select>--}}
