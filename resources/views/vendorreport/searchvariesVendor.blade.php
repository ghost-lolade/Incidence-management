            ...
            <div class="col-md-12 col-md-offset-0">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['method'=>'POST', 'action'=> 'VendorReportController@viewDailyReporter', 'target'=>'_blank','files'=>true]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date">
                                        ...
                                        <input hidden  type="text"  name="vendor_id" value="{{ Auth::user()->usertype}}">
