...
{{--                                <span class="glyphicon glyphicon-tint"></span> Suspend</button>--}}
...
<script type="text/javascript">
    ...
    {{--            } else {--}}
    {{--                toastr.success('Successfully updated Post!', 'Success Alert', {timeOut: 5000});--}}
    {{--                $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td class='col1'>" + data.id + "</td><td>" + data.terminal_id + "</td><td>" + data.atm_name + "</td><td>" + data.error_code + "</td><td>" + data.request_status + "</td><td>" + data.ce_name + "</td><td>" + data.log_day + "</td><td><button class='show-modal btn btn-success' data-id='" + data.id + "' data-title='" + data.title + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-eye-open'></span> Show</button> <button class='edit-assignmodal btn btn-info' data-id='\" + data.id + \"' data-title='\" + data.title + \"' data-content='\" + data.content + \"'><span class='glyphicon glyphicon-plus-sign'></span> Update Status</button> <button class='edit-suspendcemodel btn btn-warning' data-id='" + data.id + "' data-title='" + data.title + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-tint'></span> Suspend</button> <button class='delete-modal btn btn-primary' data-id='" + data.id + "' data-title='" + data.title + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-ok-circle'></span> Close Call</button></td></tr>");--}}
